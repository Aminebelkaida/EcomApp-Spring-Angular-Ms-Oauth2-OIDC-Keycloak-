package net.belkaida.orderservice;

import net.belkaida.orderservice.entities.Order;
import net.belkaida.orderservice.entities.OrderState;
import net.belkaida.orderservice.entities.ProductItem;
import net.belkaida.orderservice.model.Product;
import net.belkaida.orderservice.repositories.OrderRepository;
import net.belkaida.orderservice.repositories.ProducItemRepository;
...
public class OrderServiceApplication {
    ...
    CommandLineRunner commandLineRunner(
            ...
            ProducItemRepository producItemRepository,
            ...
            for (int i = 0; i < 5; i++){
                ...
                productsIds.forEach(pId -> {
                    ProductItem productItem = ProductItem.builder()
                            ...
                            .order(savedOrder)
                            .build();
                    producItemRepository.save(productItem);
                });
            }
